        ...
        implements Exchange
{
    ...
    private List<ExchangeSourceHandle> splitIntoList(ExchangeSourceHandle handle, long targetSizeInBytes)
    {
        ...
        return ImmutableList.<ExchangeSourceHandle>builder()
                .addAll(limit(cycle(new TestingExchangeSourceHandle(testingExchangeSourceHandle.getPartitionId(), targetSizeInBytes)), fullPartitions))
                .add(new TestingExchangeSourceHandle(testingExchangeSourceHandle.getPartitionId(), reminder))
                .build();
    }
