...
public class TestAesBufferCipher
{
    ...
    public void test()
    {
        ...
        assertFailure(() -> decryptExact(bufferCipher, encrypted), "Spill cipher already closed");
        assertFailure(() -> encryptExact(bufferCipher, randomBytes(1)), "Spill cipher already closed");
    }
