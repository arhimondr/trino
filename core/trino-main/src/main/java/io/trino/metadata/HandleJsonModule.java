        ...
        implements Module
{
    ...
    {
        return new AbstractTypedJacksonModule<>(ExchangeSinkInstanceHandle.class, (clazz) -> clazz.getClass().getSimpleName(), (name) -> resolver.getExchangeSinkInstanceHandleClass()) {};
    }

    @ProvidesIntoSet
    public static com.fasterxml.jackson.databind.Module exchangeSourceHandleModule(HandleResolver resolver)
    {
        return new AbstractTypedJacksonModule<>(ExchangeSourceHandle.class, (clazz) -> clazz.getClass().getSimpleName(), (name) -> resolver.getExchangeSourceHandleHandleClass()) {};
    }
}
