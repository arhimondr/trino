...
import io.trino.execution.scheduler.SqlStageBatchTaskSourceFactory;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        binder.bind(BatchTaskSourceFactory.class).to(SqlStageBatchTaskSourceFactory.class).in(Scopes.SINGLETON);
