...
import io.trino.execution.FailureInjectionService.InjectedFailure;
...
public class TaskResource
{
            ...
            FailureInjectionService failureInjectionService)
    {
        ...
        this.failureInjectionService = requireNonNull(failureInjectionService, "failureInjectionService is null");
    }
            ...
            AsyncResponse asyncResponse)
    {
        ...
        Optional<InjectedFailure> injectedFailure = failureInjectionService.getInjectedFailure(
                traceToken.get(),
        ...
        Duration timeout = failureInjectionService.getRequestTimeout();
