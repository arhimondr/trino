...
import static io.trino.execution.buffer.OutputBuffers.BufferType.SHUFFLE_SERVICE;
...
public class ShuffleServiceOutputBuffer
        implements OutputBuffer
{
    private final StateMachine<BufferState> state;
    private final OutputBuffers outputBuffers;
    private final ShuffleOutput shuffleOutput;
    ...
    public ShuffleServiceOutputBuffer(
            ...
            Supplier<LocalMemoryContext> systemMemoryContextSupplier)
    {
        ...
        checkArgument(outputBuffers.getType() == SHUFFLE_SERVICE, "Expected a SHUFFLE_SERVICE output buffer descriptor");
        this.shuffleOutput = requireNonNull(shuffleOutput, "shuffleOutput is null");
    ...
    public OutputBufferInfo getInfo()
    {
        ...
        return new OutputBufferInfo(
                ...
                false,
                state.canAddPages(),
                shuffleOutput.getSystemMemoryUsage(),
                totalPagesAdded.get(),
                totalRowsAdded.get(),
                totalPagesAdded.get(),
                ImmutableList.of());
    ...
    {
        return asVoid(toListenableFuture(shuffleOutput.isBlocked()));
    }
    ...
    public void enqueue(int partition, List<SerializedPage> pages)
    {
        ...
        for (SerializedPage page : pages) {
            ...
            shuffleOutput.add(partition, slice);
            totalRowsAdded.addAndGet(page.getPositionCount());
        }
        updateMemoryUsage(shuffleOutput.getSystemMemoryUsage());
