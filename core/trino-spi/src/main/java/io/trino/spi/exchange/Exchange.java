...
public interface Exchange
        extends Closeable
{
    ExchangeSinkId addSink(int taskPartitionId);

    void noMoreSinks();

    ExchangeSinkHandle getSinkHandle(ExchangeSinkId sinkId, int taskAttemptId);

    void sinkFinished(ExchangeSinkHandle handle);
