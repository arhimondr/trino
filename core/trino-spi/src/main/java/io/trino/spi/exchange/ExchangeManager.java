...
public interface ExchangeManager
{
     ...
     * @param preserveRecordsOrder preserve order of records within a single partition written by a single writer.
     ...
     */
    Exchange createExchange(ExchangeContext context, int outputPartitionCount, boolean preserveRecordsOrder);
