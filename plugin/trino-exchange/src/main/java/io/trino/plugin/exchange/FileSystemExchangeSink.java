        ...
        implements ExchangeSink
{
    ...
    public FileSystemExchangeSink(FileSystem fileSystem, Path outputDirectory, int outputPartitionCount)
    {
    ...
    {
        // TODO: this is not accounting buffers used for streaming upload
