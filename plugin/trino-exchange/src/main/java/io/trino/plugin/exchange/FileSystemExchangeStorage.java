...
{
    // TODO: decide if this interface should live in trino-spi
    ...
    SliceOutput createSliceOutput(URI file, Optional<SecretKey> secretKey) throws IOException;

    boolean exists(URI file);

    void createFile(URI file) throws IOException;
    ...
    long size(URI file) throws IOException;
