...
public class DistributedFileSystemExchangeQueryRunner
{
    ...
    private DistributedFileSystemExchangeQueryRunner() {}
            ...
            throws Exception
    {
        ...
        Thread.sleep(10);
        Logger log = Logger.get(DistributedFileSystemExchangeQueryRunner.class);
