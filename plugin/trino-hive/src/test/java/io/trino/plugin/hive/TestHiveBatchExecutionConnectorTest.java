...
import io.trino.testing.BaseBatchExecutionConnectorTest;

public class TestHiveBatchExecutionConnectorTest
        extends AbstractHiveConnectorTest
{
    public TestHiveBatchExecutionConnectorTest()
    {
        super(BaseBatchExecutionConnectorTest.getExtraProperties());
    }
