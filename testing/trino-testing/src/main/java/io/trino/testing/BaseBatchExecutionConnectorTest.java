...
public abstract class BaseBatchExecutionConnectorTest
        extends BaseConnectorTest
{
    ...
    protected final QueryRunner createQueryRunner()
            throws Exception
    {
        return createQueryRunner(BaseBatchExecutionConnectorTest.getExtraProperties());
    }
    ...
    public static Map<String, String> getExtraProperties()
    {
        return ImmutableMap.<String, String>builder()
                ...
                .put("batch-execution-target-partition-size", "10MB")
                .put("batch-execution-target-partition-split-count", "4")
